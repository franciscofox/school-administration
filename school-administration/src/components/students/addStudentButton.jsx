...
const AddStudentButton = ({onStudentAdd}) => {
    ...
    useEffect(() => {
        const fetchRoomOptions = async () => {
            try {
                const response = await fetch(`http://ec2-18-224-135-214.us-east-2.compute.amazonaws.com:4000/rooms`);
        ...
        const fetchSiblingOptions = async () => {
            try {
                const response = await fetch(`http://ec2-18-224-135-214.us-east-2.compute.amazonaws.com:4000/students`);
                const data = await response.json();
